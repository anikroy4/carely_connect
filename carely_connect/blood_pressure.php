<?php
// blood_pressure.php - This file renders the Blood Pressure Management page for Carely Connect website
session_start();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Blood Pressure Management - Carely Connect</title>
...
<body>
    ...
    <div class="banner">
        <img src="https://via.placeholder.com/1200x400?text=Blood+Pressure+Management" alt="Blood Pressure Banner">
        <div class="banner-content">
            <h1>Blood Pressure Management Section</h1>
        </div>
    </div>

    <section class="section">
        <h2>Number of Blood Pressure Patients</h2>
        <div class="patient-count-box">
            <h3>Blood Pressure Patients</h3>
            <div class="count">764</div>
            <p>Patients currently managed at Carely Connect for blood pressure care.</p>
        </div>
    </section>

    <section class="section">
        <h2>Food-Taking Routines for Blood Pressure</h2>
        <p>Our blood pressure management program includes low-sodium meals designed to support heart health and maintain healthy blood pressure levels. Below is a sample weekly routine for breakfast, lunch, dinner, and snacks.</p>
        <div class="weekly-plan">
            ...
            <div>Saturday</div>
            <div>Oatmeal with citrus fruit and milk</div>
            <div>Grilled salmon with carrots and boiled rice</div>
            <div>Tuna with lentils and avocado</div>
            <div>Strawberries and nuts</div>
            <div>Sunday</div>
            <div>Whole-grain bread with yogurt</div>
            <div>Beans with tomatoes and grain pasta</div>
            <div>Salmon with broccoli and vorta</div>
            <div>Mango</div>
            <div>Monday</div>
            <div>Yogurt with green fruit</div>
            <div>Tuna salad with carrots</div>
            <div>Lentils with boiled rice and garlic</div>
            <div>Avocado</div>
            <div>Tuesday</div>
            <div>Whole-grain toast with avocado</div>
            <div>Salmon with beans</div>
            <div>Tuna with tomatoes and grain pasta</div>
            <div>Citrus fruit</div>
            <div>Wednesday</div>
            <div>Oatmeal with strawberries</div>
            <div>Grilled chicken with broccoli</div>
            <div>Lentils with vorta</div>
            <div>Nuts</div>
            <div>Thursday</div>
     ...
     <section class="section">
        <h2>Food Menu</h2>
        <p>Our blood pressure-friendly menu includes low-sodium, nutrient-rich foods to support heart health and manage blood pressure levels.</p>
        <ul class="food-menu">
            <li>Citrus Fruit</li>
            <li>Green Fruit</li>
            <li>Carrots</li>
    ...
    <section class="section">
        ...
        <p>Our dedicated kitchen crew ensures that all meals are prepared with care and delivered on time. They specialize in creating nutritious, blood pressure-friendly meals.</p>
        <div class="crew-grid">
            <div class="crew-member">
                <img src="https://via.placeholder.com/100x100?text=Chef+Fatima" alt="Chef">
                <h3>Fatima Begum</h3>
                <p>Head Chef - Prepares main courses and oversees meal planning.</p>
            </div>
            <div class="crew-member">
                <img src="https://via.placeholder.com/100x100?text=Assistant+Rahim" alt="Assistant">
                <h3>Rahim Khan</h3>
                <p>Assistant Chef - Handles snacks and dietary adjustments.</p>
            </div>
            <div class="crew-member">
                <img src="https://via.placeholder.com/100x100?text=Delivery+Ayesha" alt="Delivery">
                <h3>Ayesha Siddique</h3>
        ...
        <ul class="contact-list">
            <li>
                ...
                <div class="contact-info">
                    <p><strong>Name:</strong> Fatima Begum</p>
                    <p><strong>Email:</strong> <a href="mailto:fatima@carelyconnect.com">fatima@carelyconnect.com</a></p>
                    <p><strong>Phone:</strong> <a href="tel:+8801234567891">+880 1234567891</a></p>
                </div>
            </li>
            <li>
                <div class="icon">R</div>
                <div class="contact-info">
                    <p><strong>Name:</strong> Rahim Khan</p>
                    <p><strong>Email:</strong> <a href="mailto:rahim@carelyconnect.com">rahim@carelyconnect.com</a></p>
                    <p><strong>Phone:</strong> <a href="tel:+8800987654322">+880 0987654322</a></p>
                </div>
            </li>
            <li>
                <div class="icon">A</div>
                <div class="contact-info">
                    <p><strong>Name:</strong> Ayesha Siddique</p>
                    <p><strong>Email:</strong> <a href="mailto:ayesha@carelyconnect.com">ayesha@carelyconnect.com</a></p>
                    <p><strong>Phone:</strong> <a href="tel:+8801122334456">+880 1122334456</a></p>
                </div>
            </li>
        </ul>
    </section>
