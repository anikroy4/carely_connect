...
<body>
    <header>
        ...
        <div class="header-buttons">
            ...
            <a href="signup.php" class="signup active">Sign Up</a>
    ...
    <div class="container">
        <div class="signup-container">
            <div class="illustration">
                ...
                <img src="img/sign.png" alt="Elderly woman and nurse">
            </div>
            <div class="form-section">
                ...
                <a href="signin.php" class="login-link">Already a member? Login</a>
            </div>
        </div>
    </div>
