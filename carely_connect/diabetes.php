<?php
// diabetes.php - This file renders the Diabetes Management page for Carely Connect website
session_start();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Diabetes Management - Carely Connect</title>
...
<body>
    <header>
        ...
        <div class="header-buttons">
            ...
            <h1>Diabetes Management Section</h1>
        </div>
    </div>

    <section class="section">
        <h2>Number of Diabetes Patients</h2>
        <div class="patient-count-box">
            <h3>Diabetes Patients</h3>
            <div class="count">212</div>
            <p>Patients currently managed at Carely Connect for diabetes care.</p>
        </div>
    </section>

    <section class="section">
        <h2>Food-Taking Routines for Diabetes</h2>
        <p>Our diabetes management program includes balanced meals designed to control blood sugar levels. Below is a sample weekly routine for breakfast, lunch, dinner, and snacks.</p>
        <div class="weekly-plan">
            ...
            <div>Saturday</div>
            <div>Oatmeal with nuts and strawberries</div>
            <div>Grilled chicken breast with broccoli and boiled rice</div>
            <div>Baked salmon with lentils and avocado</div>
            <div>Yogurt with garlic</div>
            <div>Sunday</div>
            <div>Whole-grain bread with yogurt</div>
            <div>Lean ground beef with beans and grain pasta</div>
            <div>Turkey with daal and vorta</div>
            <div>Nuts and strawberries</div>
            <div>Monday</div>
            <div>Oatmeal with milk</div>
            <div>Tuna salad with broccoli</div>
            <div>Chicken breast with lentils</div>
            <div>Avocado</div>
            <div>Tuesday</div>
            <div>Whole-grain toast with avocado</div>
            <div>Turkey with beans</div>
            <div>Salmon with boiled rice and daal</div>
            <div>Yogurt</div>
            <div>Wednesday</div>
            <div>Yogurt with nuts</div>
            <div>Lean ground beef stir-fry with garlic</div>
            <div>Tuna with grain pasta</div>
            <div>Strawberries</div>
            <div>Thursday</div>
            <div>Oatmeal with strawberries</div>
            <div>Chicken breast with broccoli</div>
            <div>Turkey with lentils</div>
            <div>Nuts</div>
            <div>Friday</div>
            <div>Milk with whole-grain bread</div>
            <div>Salmon with avocado</div>
            <div>Lean ground beef with vorta</div>
            <div>Yogurt with garlic</div>
        </div>
    </section>
     <section class="section">
        <h2>Food Menu</h2>
        <p>Our diabetes-friendly menu includes a variety of nutritious foods to help manage blood sugar levels.</p>
        <ul class="food-menu">
    ...
    <section class="section">
        ...
        <p>Our dedicated kitchen crew ensures that all meals are prepared with care and delivered on time. They specialize in creating nutritious, diabetes-friendly meals.</p>
        <div class="crew-grid">
            <div class="crew-member">
                <img src="https://via.placeholder.com/100x100?text=Chef+John" alt="Chef">
                <h3>Sifat UL</h3>
                <p>Head Chef - Prepares main courses and oversees meal planning.</p>
            </div>
            <div class="crew-member">
                <img src="https://via.placeholder.com/100x100?text=Assistant+Jane" alt="Assistant">
                <h3>Anik Roy</h3>
                <p>Assistant Chef - Handles snacks and dietary adjustments.</p>
            </div>
            <div class="crew-member">
                <img src="https://via.placeholder.com/100x100?text=Delivery+Mike" alt="Delivery Mike">
                <h3>Rakib Hasan</h3>
        ...
        <ul class="contact-list">
            <li>
                ...
                <div class="contact-info">
                    <p><strong>Name:</strong>  Sifat UL</p>
                    <p><strong>Email:</strong> <a href="mailto:sifat@carelyconnect.com">sifat@carelyconnect.com</a></p>
                    <p><strong>Phone:</strong> <a href="tel:+8801234567890">+880 1234567890</a></p>
                </div>
            </li>
            <li>
                <div class="icon">A</div>
                <div class="contact-info">
                    <p><strong>Name:</strong>  Anik Roy</p>
                    <p><strong>Email:</strong> <a href="mailto:anik@carelyconnect.com">anik@carelyconnect.com</a></p>
                    <p><strong>Phone:</strong> <a href="tel:+8800987654321">+880 0987654321</a></p>
                </div>
            </li>
            <li>
                <div class="icon">R</div>
                <div class="contact-info">
                    <p><strong>Name:</strong>  Rakib Hasan</p>
                    <p><strong>Email:</strong> <a href="mailto:rakib@carelyconnect.com">rakib@carelyconnect.com</a></p>
                    <p><strong>Phone:</strong> <a href="tel:+8801122334455">+880 1122334455</a></p>
                </div>
            </li>
        </ul>
    </section>
