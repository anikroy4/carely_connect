<?php
// addstaf.php - This file renders the Add New Staff page for Carely Connect website
session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Basic validation
    if (!empty($name) && !empty($age) && !empty($gender) && !empty($emergencyContact) && !empty($salary) && !empty($qualification) && !empty($position)) {
        // Prepare data to save
        $staffData = "Name: $name, Age: $age, Gender: $gender, Emergency Contact: $emergencyContact, Salary: $salary, Qualification: $qualification, Position: $position, Date: " . date('Y-m-d H:i:s') . "\n";
        
        // Define file path
        $file = __DIR__ . '/staff_data.txt';
        ...
        $success = file_put_contents($file, $staffData, FILE_APPEND | LOCK_EX);
        
        if ($success !== false) {
            // Output JavaScript to show success popup and redirect
            echo "<script>alert('Staff added successfully'); window.location.href = 'addstaf.php';</script>";
        } else {
            echo "<script>alert('Error saving staff data. Please check permissions.'); window.location.href = 'addstaf.php';</script>";
        }
        exit;
    } else {
        echo "<script>alert('Please fill all required fields.'); window.location.href = 'addstaf.php';</script>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Add New Staff - Carely Connect</title>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="addstaf.php" class="active">Staffs</a></li>
        ...
        <div class="form-container">
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="emergency-contact" name="emergency-contact" placeholder="Enter Contact" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="selection-group">
                        <div class="custom-radio">
                            <input type="radio" id="doctor" name="position" value="doctor" required>
                            <span></span>
                        ...
                        <div class="custom-radio">
                            <input type="radio" id="general-staff" name="position" value="general-staff">
                            <span></span>
                            <label for="general-staff">General Staff</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
